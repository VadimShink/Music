...
//  Music
//
//  Created by Vadim Shinkarenko on 22.09.2022.
//
                    ...
                    HStack(spacing: 16) {
                        Button(action: {
                            ...
                            Image(systemName: "play.fill")
                                ...
                                .accentColor(Color.init(red: 230/255, green: 62/255, blue: 67/255))
                                .background(Color.init(red: 238/255, green: 238/255, blue: 239/255))
                                .cornerRadius(10)
                        })
                        Button(action: {
